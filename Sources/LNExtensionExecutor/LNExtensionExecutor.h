...
- (nullable instancetype)initWithExtensionBundleIdentifier:(NSString*)bundleId error:(NSError* __nullable __autoreleasing *)error NS_DESIGNATED_INITIALIZER;

+ (nullable instancetype)executorWithExtensionBundleIdentifier:(NSString*)bundleIdentifier NS_REFINED_FOR_SWIFT;
+ (nullable instancetype)executorWithExtensionBundleIdentifier:(NSString*)bundleIdentifier error:(NSError* __nullable __autoreleasing*)error NS_REFINED_FOR_SWIFT;
